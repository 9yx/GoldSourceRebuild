#ifndef ENGINE_VGUI_ENGINESURFACEWRAP_H
#define ENGINE_VGUI_ENGINESURFACEWRAP_H
...
{
public:
	EngineSurfaceWrap( vgui::Panel* embeddedPanel, IEngineSurface* engineSurface );
	~EngineSurfaceWrap();
...
#endif //ENGINE_VGUI_ENGINESURFACEWRAP_H
